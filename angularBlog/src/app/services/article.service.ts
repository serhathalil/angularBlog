...
export class ArticleService {
  ...
  private apiUrl: string = "https://localhost:44329/api/makales";
  ...
  getArciveList(year:number,month:number,page:number,pageSize:number){
    let api=`${this.apiUrl}/GetArciveList/${year}/${month}/${page}/${pageSize}`;
